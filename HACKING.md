...
hidden if the `krompir_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `krompir_DEVELOPER_MODE` to the configure
...
Runs the executable target `krompir_exe`.
